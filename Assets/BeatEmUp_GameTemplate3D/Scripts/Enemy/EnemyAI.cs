...
public class EnemyAI : EnemyActions, IDamagable<DamageObject>{
	...
	void Start(){
		...
		// Get the reference to GameOverScript
	...
	void Death(){
		...
		// Trigger GameOver logic with delay
    	if (gameOverScript != null)
    	{
    	    gameOverScript.TriggerGameOver(); // This will start the 3-second delay and then call LevelComplete
    	}
	}
}
